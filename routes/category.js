...
router.get('/', async (req, res) => {
    try {
      ...
      res.render('admin/category/index', { categories, layout: 'layoutAdmin.hbs'});
    } catch (error) {
      console.error(error);
  ...
  router.get('/add', (req, res) => {
    res.render('admin/category/add', {layout : 'layoutAdmin.hbs'});
 })
 ...
 router.get('/deleteall', async (req, res) => {
  ...
  router.get('/edit/:id', async (req, res) => {
    ...
    res.render('admin/category/edit', { category, layout : 'layoutAdmin'});
 })
